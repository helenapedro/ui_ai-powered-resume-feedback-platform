          ...
          <CardContent>
            {!showEmailForm ? (
              <div className="space-y-3">
                ...
                <Button
                  className="w-full h-12 text-base gap-3 bg-destructive hover:bg-destructive/90 text-destructive-foreground"
              ...
              <>
                <Button
                  variant="ghost"
                  size="sm"
                  className="mb-4 -ml-2 text-muted-foreground gap-1"
